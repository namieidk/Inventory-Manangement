...
if (!isset($_SESSION['last_NewSupplier_log']) || (time() - $_SESSION['last_NewSupplier_log']) > 300) { // 300 seconds = 5 minutes
    logAction($conn, $userId, "Accessed New Supplier Page", "User accessed the New Supplier page");
    $_SESSION['last_NewSupplier_log'] = time();
}
